...
def _noisy_action_impl(
    ...
    # For each step, constant motion bias can randomly happen
    fw_bias = random.choice([0.05, -0.05, 0.1, -0.1, 0.15, -0.15])
    th_bias = random.choice([5 / 3, -5 / 3, 10 / 3, -10 / 3, 5, -5])  # Relative to 10 deg
