...
fwd_mult_factor = 1000  # This makes standard deviation to get near 0.1
rot_mult_factor = 50  # This makes standard deviation to get near 3.3

actuation_noise_fwd.covariances_ *= fwd_mult_factor
actuation_noise_left.covariances_ *= rot_mult_factor
actuation_noise_right.covariances_ *= rot_mult_factor
